...
public class FileDocumentUtil {
	 ...
	 *
	 * @param fields
	 * : collection of fieldName
	 * @param analyzer
	 * : lexical analyzer
	 * @param findString
	 * : The keywords you need to find
	 * @return Query
	 * @throws Exception
	 */
	...
	public static Document file2Document(String filepath) throws Exception {
		...
		// When using String to search
// doc.add(new Field("size", String.valueOf(file.length()), Store.YES,
// Index.ANALYZED));
// When using NumberTools.longToString() to search, you need to build this when building the index library.
	 ...
	 *
	 * @param docs
	 * : TopDocs object, storing documents
	 * @param highlighter
	 * : Highlighter
	 * @param analyzer
	 * : lexical parser
	 * @param indexSearcher
	 * : Index Finder Example: IndexSearcher indexSearcher = new
	 ...
	 * @throws Exception
	 */
	public static void ergodicDocument(TopDocs docs, Highlighter highlighter, Analyzer analyzer,
